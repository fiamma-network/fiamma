...
func (x *fastReflection_MsgSendTask) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.PublicInput != "" {
		value := protoreflect.ValueOfString(x.PublicInput)
...
func (x *fastReflection_MsgSendTask) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "fiamma.zkpverify.MsgSendTask.publicInput":
		x.PublicInput = value.Interface().(string)
	case "fiamma.zkpverify.MsgSendTask.vk":
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 4:
				...
				x.PublicInput = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 5:
				if wireType != 2 {
...
func (x *MsgSendTask) GetProof() string {
	if x != nil {
		return x.Proof
	}
	return ""
...
func (x *MsgSendTask) GetPublicInput() string {
	if x != nil {
		return x.PublicInput
	}
	return ""
...
func (x *MsgSendTask) GetVk() string {
	if x != nil {
		return x.Vk
	}
	return ""
...
var file_fiamma_zkpverify_tx_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x05, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x12, 0x20, 0x0a, 0x0b, 0x70, 0x75, 0x62, 0x6c,
	0x69, 0x63, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x70,
	0x75, 0x62, 0x6c, 0x69, 0x63, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x76, 0x6b,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x76, 0x6b, 0x3a, 0x0c, 0x82, 0xe7, 0xb0, 0x2a,
